...
def getFontForPyGame(font_name="Deng.ttf", font_size=14):
...
def makeConfig(cfg=None):
    ...
    default_cfg = {
        ...
        "padding": (30, 36, 40, 36),
        "line-height": 40,  # px
        "title-line-height": 64,  # px
        "font-size": 28,  # px
        "title-font-size": 48,  # px
        "font-family": "Deng.ttf",
...
def txt2im(txt, outfn, cfg=None, show=False, _return=False):
    cfg = makeConfig(cfg)
